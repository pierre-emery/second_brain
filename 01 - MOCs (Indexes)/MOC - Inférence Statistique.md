...
## 1) Cadre général de l'inférence
...
## 2) Principes d'inférence : vraisemblance, conditionnement, suffisance
...
## 3) Données : types, échelles et plans d'étude

### Types de variables et échelles de mesure
...
### Nature des données et plan d'étude (design)
...
## 7) Décision statistique : pertes, risques, règles

### Fondations

- [[C - Fondements de la théorie de décision]]
- [[C - Règle de décision]]
- [[C - Fonction de perte]]
- [[C - Test d'hypothèse]]
### Pertes usuelles
...
- [[C - Perte Quadratique Pondérée]]
- [[C - Perte Linéaire]]
- [[C - Perte 0-1]]
### Risques (fréquentiste vs bayésien)

- [[C - Risque et Perte (classique)]]
- [[C - Risque Fréquentiste]]
- [[C - Risque et Perte (bayésien)]]
- [[C - Risque intégré]]
- [[C - Perte Espérée à postériori]]
### Estimateurs de Bayes

- [[C - Estimateur de Bayes]]
- [[C - Estimateur de Bayes formel]]
- [[C - Estimateur de Bayes partiel]]
## 8) Minimax, maximin et admissibilité
...
- [[C - Minimaxité]]
- [[C - Maximin]]
- [[C - Estimateur Minimax]]
- [[C - Admissibilité]]
### Synthèses / liens

- [[C - Minimaxité et admissibilité (classique)]]
- [[C - Lien Estimateurs Bayésiens, Minimax et Admissible]]
### Résultats

- [[T - Conditions Minimax]]
## 9) Règles aléatoires et réduction d'estimateurs

- [[C - Règles de décision aléatoires]]
- [[T - Théoreme estimateur non-aléatoire]]
- [[T - Dé-randomisation (perte convexe)]]
- [[T - Rao-Blackwell]]
## 10) Outils techniques (math)

- [[T - Loi de l'espérance totale]]
- [[T - Règle de Leibniz]]
